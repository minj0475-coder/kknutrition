...
2. 등록 문항이 없으면 배포 사이트의 `data/today-menu.json`에서 오늘 메뉴를 읽어 관련 영양교육 문항을 최대 2개 선정합니다.
3. 메뉴 데이터가 없거나 연결할 주제가 부족해도 날짜별 일반 영양교육 문항을 보충하여 매일 3문항을 제공합니다.
4. 같은 날짜에는 같은 문항이 제공되고 날짜가 바뀌면 자동으로 문항 구성이 바뀝니다.
