(function initKknAllergy(root) {
  ...
  const definitions = [
    { id: 1, label: '난류', aliases: ['달걀', '계란'], patterns: [/달걀|계란|전란|난백|난황|에그|마요네즈|흑임자드레싱/] },
    ...
    { id: 6, label: '밀', aliases: [], patterns: [/(?:^|[\s/(,])밀(?:$|[\s/),])|밀가루|통밀|소맥|튀김가루|부침가루|빵가루|하이스가루|자장면|라면|우동|소면|중면|국수|수제비|만두피|또띠아|식빵|모닝빵|파스타|스파게티|마카로니|떡갈비/] },
