...
const DAILY_KKUL_MESSAGES = [
  ...
  { type: "encouragement", text: "가볍게 건넨 첫인사가 오늘의 좋은 흐름을 열어줄 거예요." },
  { type: "work", text: "작은 확인 하나가 다음 업무를 훨씬 편하게 만들어줘요." },
  { type: "rest", text: "두 손을 모으고 숨을 한 번 고르면 마음도 제자리를 찾아요." },
  { type: "encouragement", text: "오늘의 당신에게도 다정한 응원을 넉넉히 보낼게요." },
  { type: "work", text: "시간을 먼저 확인하면 바쁜 하루도 한결 차분해져요." },
  { type: "work", text: "체크리스트 한 줄이 놓칠 일을 든든하게 붙잡아줘요." },
  { type: "quote", text: "“성찰하지 않는 삶은 살 가치가 없다.” — 소크라테스, 《소크라테스의 변명》" },
  { type: "work", text: "완료 표시 하나가 머릿속의 할 일을 가볍게 덜어줘요." },
  { type: "work", text: "달력에 적어둔 한 줄이 내일의 서두름을 줄여줘요." },
  { type: "encouragement", text: "작은 목표라도 깃발을 세우면 도착할 곳이 선명해져요." },
  { type: "quote", text: "“좋은 정신을 갖는 것보다 잘 사용하는 일이 중요하다.” — 데카르트, 《방법서설》" },
  { type: "work", text: "자료를 한곳에 모아두면 찾는 시간도 실수도 함께 줄어요." },
  { type: "quote", text: "“잘 먹지 않고서는 잘 생각하고 사랑하고 잠들 수 없다.” — 버지니아 울프, 《자기만의 방》" },
  { type: "encouragement", text: "정성을 담아 건넨 한 끼는 오늘도 누군가에게 힘이 돼요." },
  { type: "work", text: "식판의 균형처럼 업무도 하나씩 채우면 흐름이 보여요." },
  { type: "rest", text: "답이 바로 안 보일 땐 국자를 잠시 내려놓고 다시 봐도 괜찮아요." },
  { type: "encouragement", text: "익숙한 손길과 꾸준한 마음이 오늘의 든든한 실력이에요." },
  { type: "work", text: "마지막 확인은 일을 늦추는 게 아니라 마음 놓고 끝내는 과정이에요." },
  { type: "quote", text: "“지식 그 자체가 힘이다.” — 프랜시스 베이컨, 《성스러운 명상》" },
  { type: "work", text: "작은 숫자와 짧은 메모도 한 번 더 보면 중요한 단서가 돼요." },
  { type: "quote", text: "“배우기만 하고 생각하지 않으면 얻는 것이 없다.” — 공자, 《논어》" },
  { type: "work", text: "자료를 바로 기록해두면 기억에 기대지 않아도 괜찮아요." },
  { type: "rest", text: "화면을 오래 봤다면 눈을 떼고 먼 곳을 잠깐 바라봐요." },
  { type: "work", text: "계산은 천천히 두 번, 마음은 가볍게 한 번이면 충분해요." },
  { type: "quote", text: "“천재는 1%의 영감과 99%의 노력으로 이루어진다.” — 토머스 에디슨" },
  { type: "encouragement", text: "오늘의 가능성은 생각보다 가까이에 있어요. 두 팔 벌려 맞아봐요." },
  { type: "encouragement", text: "조용한 꾸준함도 분명한 성장입니다. 수줍어도 괜찮아요." },
  { type: "encouragement", text: "한 걸음 움직이면 멈춰 있던 마음도 다시 리듬을 찾아요." },
  { type: "encouragement", text: "마음이 무거운 날에도 작은 기대 하나는 높이 띄워봐요." },
  { type: "quote", text: "“열정 없이 이루어진 위대한 일은 없다.” — 랠프 월도 에머슨, 《에세이》" },
  { type: "rest", text: "우유 한 모금 마시듯 서두르지 말고 부드럽게 쉬어가요." },
  { type: "rest", text: "포근하게 쉬는 시간도 오늘을 잘 살아내는 중요한 일정이에요." },
  { type: "rest", text: "졸음이 오는 날엔 속도를 낮추고 가장 필요한 일만 해도 괜찮아요." },
  { type: "rest", text: "피곤하다는 신호를 알아차렸다면 잠깐 멈추는 게 먼저예요." },
  { type: "rest", text: "비 오는 계절엔 우산 아래서 호흡도 걸음도 조금 천천히 해요." },
  { type: "encouragement", text: "햇살이 환한 계절처럼 오늘의 좋은 점도 곧 선명해질 거예요." },
  { type: "quote", text: "“누군가의 구름 속에 무지개가 되어주세요.” — 마야 안젤루" },
  { type: "rest", text: "겨울의 차가운 공기 속에서도 따뜻한 차 한 잔만큼은 천천히 즐겨요." },
  { type: "work", text: "행운을 기다리는 동안 오늘의 확인 한 칸을 먼저 채워둘까요?" },
  { type: "encouragement", text: "작은 아이디어 하나도 잘 품으면 별처럼 반짝일 수 있어요." },
  { type: "quote", text: "“우연은 준비된 마음을 돕는다.” — 루이 파스퇴르, 릴 대학 연설" },
  { type: "encouragement", text: "새해의 복주머니처럼 오늘의 좋은 기운도 차곡차곡 담아가요." },
  { type: "quote", text: "“삶은 대담한 모험이거나 아무것도 아니다.” — 헬렌 켈러, 《열린 문》" },
  { type: "encouragement", text: "오늘의 작은 성취도 촛불을 켜듯 기쁘게 축하해 주세요." },
  { type: "rest", text: "겨울과 성탄의 설렘 속에서도 바쁜 마음은 잠시 쉬어가도 좋아요." },
  { type: "work", text: "새해 업무는 첫 기록을 또박또박 남기면 한 해의 흐름이 편해져요." },
  { type: "rest", text: "봄꽃이 피는 계절엔 일 사이에도 향기로운 쉼표 하나를 놓아봐요." },
  { type: "rest", text: "여름의 가벼운 여행처럼 잠깐 다른 풍경을 보는 것도 좋은 휴식이에요." },
  { type: "quote", text: "“교육은 세상을 바꿀 수 있는 가장 강력한 무기다.” — 넬슨 만델라" },
  { type: "quote", text: "“진정한 발견은 새로운 눈으로 보는 데 있다.” — 마르셀 프루스트" },
  { type: "rest", text: "구름 위에 누운 것처럼 어깨의 힘을 빼고 잠깐 숨을 골라요." },
  { type: "encouragement", text: "뜻밖의 일이 생겨도 하나씩 살피면 다시 길을 찾을 수 있어요." },
  { type: "quote", text: "가을 핼러윈에도 기억해요. “두려워할 것은 두려움 그 자체다.” — 프랭클린 D. 루스벨트" },
  { type: "rest", text: "마음이 납작해진 날엔 아무것도 하지 않는 몇 분도 괜찮아요." },
  { type: "work", text: "머리가 멍할 땐 해야 할 일 하나만 적어도 업무가 다시 움직여요." }
];
